                ...
                <div class="col-12">
                    <div class="delicious-cool-facts-area">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="{{ asset('user/img/core-img/hamburger.png') }}" alt="">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="{{ asset('user/img/core-img/rib.png') }}" alt="">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="single-cool-fact">
                                    <img src="{{ asset('user/img/core-img/pancake.png') }}" alt="">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="{{ asset('user/img/core-img/hamburger2.png') }}" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="{{ asset("user/img/core-img/pizza.png") }}" alt="">
                                    <h5>Italian Food</h5>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-feature-area mb-80">
                                <div class="d-flex align-items-center mb-30">
                                    <img src="{{ asset('user/img/core-img/cake2.png') }}" alt="">
                                    <h5>Sweets &amp; Cakes</h5>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum nec varius dui. Suspendisse potenti. Vestibulum ac pellentesque tortor.</p>
                            </div>
